...
export function isLegalStageTransition(from: Stage, to: Stage): boolean {
...
export const CRM_STATUS_TO_STAGE: Record<LegacyCrmStatus, Stage> = {
  new: "new",
  contacted: "contacted",
 ...
 */
export const STAGE_TO_CRM_STATUS: Record<Stage, LegacyCrmStatus> = {
  new: "new",
  contacted: "contacted",
